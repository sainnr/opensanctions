...
echo $OS_LATEST
zip master.zip $OS_LATEST
scp -P 23000 /home/ec2-user/opensanctions/data/json/master.zip Swiftdfeed@agilertech.com:/home/Swiftdfeed/opensanctions/master.zip
